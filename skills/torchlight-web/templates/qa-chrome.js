/* qa-chrome.js — torchlight-web 标准验收运行时(由 init.mjs 内联进 index.html)。
 *
...
(() => {
  ...
  /* Content protection belongs to the full QA document, including the
     toolbar and component-mode roots. Classic figma-render installs the
     same guard first; the document marker makes this call idempotent. */
