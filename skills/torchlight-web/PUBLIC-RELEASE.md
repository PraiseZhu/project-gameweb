# torchlight-web Public Release Boundary

`torchlight-web` is the canonical identity of this Torchlight Figma-to-Web UI verification Skill. It is a Skill and verification toolchain, not an AppStore app. Local Torch demo output is an example used for local verification only.
