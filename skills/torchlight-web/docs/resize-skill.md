...
| Page scroll lock | Product page height ends at the bg/pc (PC) or bg/mobile (mobile) board bottom. Do not cap to the last CTA (that clips the board). Other bg/* slices do not set page height. |
