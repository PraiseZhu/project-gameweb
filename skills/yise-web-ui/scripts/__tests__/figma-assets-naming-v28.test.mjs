...
test('figma-naming v2.8 visual prefixes override TEXT for asset slicing', () => {
  const picks = pickSliceNodes(truthWith([
    ...
    { id: 'bad-slash', type: 'TEXT', name: 'img\uFF0Fbad', box: { x: 0, y: 120, w: 220, h: 80 }, style: { fills: [{ type: 'SOLID' }] } },
  ...
  assert.deepEqual(ids, ['visual-text']);
